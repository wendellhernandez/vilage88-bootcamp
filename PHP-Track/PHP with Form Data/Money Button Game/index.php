...
<body>
    <header>
        <span>Your Money: <?= $_SESSION['money'] ?></span>
        <form action="bet_process.inc.php"  method="post">
    ...
    <main>
        <div class="bet_container" id="low_risk">
            ...
            <form action="bet_process.inc.php" method="post">
                ...
                <input type="submit" name="lowrisk_button" value="BET">
            </form>
            <p>by -25 up to 100</p>
        </div>
        <div class="bet_container" id="moderate_risk">
            ...
            <form action="bet_process.inc.php" method="post">
                ...
                <input type="submit" name="moderaterisk_button" value="BET">
            </form>
        ...
        <div class="bet_container" id="high_risk">
            ...
            <form action="bet_process.inc.php" method="post">
                ...
                <input type="submit" name="highrisk_button" value="BET">
            </form>
        ...
        <div class="bet_container" id="severe_risk">
            ...
            <form action="bet_process.inc.php" method="post">
                ...
                <input type="submit" name="severerisk_button" value="BET">
            </form>
...
<?php
    if(isset($_SESSION['game_data'])){
        foreach($_SESSION['game_data'] as $log){ ?>
